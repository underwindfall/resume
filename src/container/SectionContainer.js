...
export const SectionContainer = ({
  ...
  return (
    <PageContainer className={classes.container} style={style} {...remainProps}>
      <RowContainer className={classes.rowContainer}>
        ...
        <QFText variant="h3" font="bold" className={classes.textIcon} text={sectionTitle} />
      </RowContainer>
      <PageContainer className={classes.itemContainer}>{children}</PageContainer>
    </PageContainer>
  );
};
...
SectionContainer.propTypes = {
  ...
  sectionIcon: PropTypes.oneOf(['experience', 'skills', 'education', 'contact']).isRequired,
